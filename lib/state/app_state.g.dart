...
mixin _$AppState on _AppState, Store {
  ...
  Future<bool> _registerOrLogin(
      {required LoginOrRegisterFunciton funciton,
      required String email,
      required String password}) {
    return _$_registerOrLoginAsyncAction.run(() => super._registerOrLogin(
        funciton: funciton, email: email, password: password));
  }
